...
| M5:语法等级与收藏 | 已完成 | Tanos HTML 页面仍为 500，但同源公开 N1–N5 `.doc` grammar list 已生成固定静态字典 | 语法等级来自可审计静态数据；N4 四组展示、收藏重校准、Mokuro v3 缓存迁移、来源页与浏览器验收均已完成 |
...
M3 功能提交:`5684b74`。M4 功能提交:`ff1bcdd`、`ba2327e`、`00a67c8`、`9a9115d`、`4e64bf1`、`8e0d16a`。M4 已通过单元测试、lint、生产构建和浏览器验收。M5 已完成：HTML list 页面在 `2026-07-12` 为 HTTP 500，但同源公开 `.doc` grammar list 可稳定提取；固定字典、四组展示、收藏校准、来源公开与缓存迁移均已交付。
