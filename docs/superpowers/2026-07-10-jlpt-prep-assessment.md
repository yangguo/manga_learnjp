...
日期: 2026-07-10
最后更新: 2026-07-12
状态: M4 已完成 / M5 降级实施中 / 语法等级数据准入受 Tanos 上游 500 阻塞
...
| M5:语法等级与收藏 | 降级实施中：语法收藏 | Tanos 许可页可审查，但 N1–N5 页面均返回 HTTP 500；先交付独立语法收藏 | 不展示或持久化语法等级；上游恢复并通过数据准入后才能启用固定字典和四组展示 |
...
M3 功能提交:`5684b74`。M4 功能提交:`ff1bcdd`、`ba2327e`、`00a67c8`、`9a9115d`、`4e64bf1`、`8e0d16a`。M4 已通过单元测试、lint、生产构建和浏览器验收。M5 数据准入已探测：Tanos 许可页可审查，但五级 grammar list 端点在 `2026-07-12` 均为 HTTP 500；当前下一步:实施不含语法等级的独立语法收藏。
